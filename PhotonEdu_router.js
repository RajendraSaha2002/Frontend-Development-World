/**
 * Lumina Q-Suite App Viewport Routing Management
 */
document.addEventListener('DOMContentLoaded', () => {
    const tabButtons = document.querySelectorAll('.nav-tab-btn');
    const modules = document.querySelectorAll('.lq-module-view');
    ...
    tabButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            // Handle forced layout refitting for nested Canvas frames
